...
var svg = d3.select("#network-eb-graph").append("svg")
    .attr("width", diameter)
...
$.ajax({
  ...
  success: function(data){
    if(data){
      ...
      var entries = entries_handler(data,names);
